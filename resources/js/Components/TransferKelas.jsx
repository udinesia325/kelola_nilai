                    ...
                    <form onSubmit={handleSubmit} className='my-4 '>
                        <div className="flex gap-x-2">
                            ...
                            <div className="form-control flex-1">
                                ...
                                <select className="select select-bordered" defaultValue={kelas[0].id} onChange={(e) => setData("kelas_asal",e.target.value)}>
                                    {kelas.map((k, _i) => (
                            ...
                            <div className="form-control flex-1">
                                ...
                                <select className="select select-bordered" defaultValue={kelas[0].id}  onChange={(e) => setData("kelas_tujuan",e.target.value)}>
                                    {kelas.map((k, _i) => (
                                        <option key={_i} value={k.id}>{k.nama_kelas}</option>
                                    ))}
                                </select>
